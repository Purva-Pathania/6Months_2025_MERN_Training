...
console.log(i_am_array)                                    //a
i_am_array.forEach((ele,index)=>{
    console.log(ele)                                       //b
})
let teen_guna = i_am_array.map((el,index)=>{               //c
    return el*3
})
console.log(teen_guna)                                     //d
console.log(teen_guna.length)                              //e
console.log("teen_guna type is: ",typeof(teen_guna))       //f
...
let array_forty = []
for(let i=0;i<40;i++){
    array_forty.push(i+1)
}
console.log(array_forty, "Length of array_forty: ", array_forty.length)      //a

let chotu_array = array_forty.filter((el,index)=>{                           //b
    if(el%2==0){
        return el
    }
})
console.log(chotu_array, "Length of chotu_array: ", chotu_array.length)      //c

//3. Create an array of country and use foreach to print the country name

let country = ["India", "Sri Lanka", "Africa" , "America" , "Canada"]
...
let smaller_array = data.map((el,index)=>{
    return {
        name : el.info.name,
